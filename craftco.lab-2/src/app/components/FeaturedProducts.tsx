          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button
                  className="w-full bg-[#D85C63] text-white py-3 px-6 rounded-xl transition-all duration-300 hover:bg-[#D85C63]/90 hover:shadow-lg relative overflow-hidden group/btn"
                  style={{
